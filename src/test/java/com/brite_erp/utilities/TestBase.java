...
//        String filePath = System.getProperty("user.dir") + "\\test-output\\report.html";
        ...
        report.setSystemInfo("QA Engineer", "Online_29");

        htmlReporter.config().setDocumentTitle("Online29 Brite-Erp Tests Reports");
        htmlReporter.config().setReportName("Online29 Brite-Erp Automated Smoke Tests Reports");
